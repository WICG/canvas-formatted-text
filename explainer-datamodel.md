...
## Note: this explainer is a work-in-progress
We are in the process of splitting the core explainer into three separate explainers 
that are focused on different aspects of the Formatted Text proposal:
1. Data Model
2. Rendering
3. Metrics
